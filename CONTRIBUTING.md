...
Please [create an issue](https://gitlab.com/gitlab-com/business-technology/engineering/access-manager/packages/composer/google-cloud-sdk/-/issues) and describe what you'd like to see. Since this project is designed as an internal tool, we will help where we can but no guarantees.
...
cd ~/Sites
git clone https://gitlab.com/gitlab-com/business-technology/engineering/access-manager/packages/composer/google-cloud-sdk.git
...
ln -s ~/Sites/google-cloud-sdk google-cloud-sdk
```
...
"autoload": {
    "psr-4": {
        "App\\": "app/",
        "Glamstack\\GoogleCloud\\": "packages/glamstack/google-cloud-sdk/src"
    }
},
```
...
composer config repositories.google-cloud-sdk '{"type": "path", "url": "packages/glamstack/google-cloud-sdk"}' --file composer.json

composer require glamstack/google-cloud-sdk

# Package operations: 1 install, 0 updates, 0 removals
#  - Installing glamstack/google-cloud-sdk (dev-1-add-package-scaffolding): Symlinking from packages/glamstack/google-cloud-sdk
```
